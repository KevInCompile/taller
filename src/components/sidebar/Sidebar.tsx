...
const Sidebar = () => {
  ...
  return (
    <aside className="w-64 min-w-64 bg-brand-dark text-white p-6 flex flex-col h-screen sticky top-0">
      ...
      <nav className="flex flex-col flex-1 gap-1 overflow-y-auto">
        ...
        <NavItem to="/types-services" icon={<Tag size={20} />} label="Tipos de Servicio" />
